...
import OrderBestellung from '@/views/Order/items/OrderBestellung'
...
const routes = [
  ...
  {
    path: '/customer/confirmRegister',
    name: 'confirmRegister',
    component: () => import('../views/LoginAndRegister/ConfirmRegister')
  },
  {
    path: '/customer/confirmChangeEmail',
